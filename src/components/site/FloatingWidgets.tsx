...
export function FloatingWidgets() {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-[max(14px,env(safe-area-inset-bottom))] right-3.5 z-40 flex flex-col items-end gap-3 sm:bottom-5 sm:right-5">
        {showTop && (
          <button
        ...
        <a
          ...
          className="grid h-[44px] w-[44px] place-items-center rounded-full bg-[#25D366] text-white shadow-md hover:brightness-110 transition sm:h-[48px] sm:w-[48px]"
          aria-label="Fale pelo WhatsApp"
          title="Fale pelo WhatsApp"
        >
          <svg viewBox="0 0 32 32" className="h-[22px] w-[22px] sm:h-6 sm:w-6" fill="currentColor" aria-hidden="true">
